...
@Implementation.CyclicDependency(type = INmsLogic.class, version = Version.v1_21_1)
public class v1_21_1 implements INmsLogic
{
                                                  ...
                                                  DropDisplay dropDisplay)
    {
        ...
        ClientboundAddEntityPacket addDisplay = new ClientboundAddEntityPacket(
                entity.getId(),
                entity.getUUID(),
                entity.getX(),
                entity.getY(),
        ...
        if(dropDisplay.useInteraction)
        {
            ...
            ClientboundAddEntityPacket addInteraction = new ClientboundAddEntityPacket(
                    interaction.getId(),
                    interaction.getUUID(),
                    interaction.getX(),
                    interaction.getY(),
                    ...
                    interaction.getType(),
                    0,
                    interaction.getDeltaMovement(),
                    interaction.getYHeadRot()
            );
            @SuppressWarnings("DataFlowIssue")

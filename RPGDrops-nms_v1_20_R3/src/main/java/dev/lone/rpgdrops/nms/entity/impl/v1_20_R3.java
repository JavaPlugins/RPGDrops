...
@Implementation.CyclicDependency(type = IEntityNms.class, version = Version.v1_20_R3)
public class v1_20_R3 implements IEntityNms<ClientboundSetPassengersPacket, net.minecraft.world.entity.Entity>
{
    @Override
